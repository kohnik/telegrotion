...
import {GameWindowLeaderBoardComponent} from '../game-window-leader-board/game-window-leader-board.component';
import {GameFinishPageComponent} from '../game-finish-page/game-finish-page.component';
  ...
  constructor(
    ...
    this.wsService.messages
      ...
      .subscribe(({ content, topic }) => {
        ...
        if(parseContent.eventId === EWSEventTypes.QUIZ_FINISHED) {
          this.currentSlide = null;
          this.players = parseContent.players;
