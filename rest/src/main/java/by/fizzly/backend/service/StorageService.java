...
public class StorageService {
    ...
    private String bucketName = "fizzly-bucket";
    ...
    public String uploadFile(InputStream inputStream, String filename, String location) {
        try {
            ...
            String storagePath = String.format("%s/%s", location, filename);
    ...
    public String deleteFile(String filename, String location) {
        try {
            ...
            return String.format("File [%s] deleted [%s]", filename, deleted ? "successfully" : "failed");
